...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="Profissional/Profissional.css" rel="stylesheet" />       
...
<body class=" container-fluid">  
    ...
    <header>
            <nav class="navbar navbar-expand-md navbar-light     container-xxl ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav menu    ">
                            <li class="nav-item col-6 col-md-auto">
                                <a class="nav-link p-2" href="index.aspx">Home</a>
                            </li>
                            <li class="nav-item col-6 col-md-auto">
                                <a class="nav-link p-2" href="Serviços.aspx">Serviços</a>
                            </li>
                            <li class="nav-item col-6 col-md-auto">
                                <a class="nav-link p-2" href="sobre.aspx">Sobre</a>
                            </li>
                            ...
                            <li class="nav-item col-6 col-md-auto d-md-none d-block">
                                <a class="nav-link p-2" href="~/Cadastro.aspx">Cadastrar</a>
                            </li>
                        </ul>
                    </div>
                ...
                <a type="button" class="btn btn-outline-danger d-none d-md-block   " href="Cadastro.aspx" style="float:right;margin:10px 0 0 10px">Cadastro</a>
            </nav>
        </header>
                    ...
                    <div class="bd-example container-xxl " style="min-height:100px;   padding: 0 20px 0 20px">
                        ...
                        <div class="row">
                            ...
                            <div class="bd-example" style=" margin:auto; ">
                              ...
                              <asp:ImageMap   runat="server"  ImageUrl="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14629.541702315722!2d-46.600461!3d-23.554597!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce594b95eddcef%3A0xcafbdac5346df73!2sR.%20do%20Orat%C3%B3rio%2C%20426%20-%20Mooca%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2003116-000%2C%20Brasil!5e0!3m2!1spt-BR!2sus!4v1618190538335!5m2!1spt-BR!2sus"
                                        Cssclass=" container-fluid " height="300" style="border:0;" allowfullscreen="" loading="lazy">
                                </asp:ImageMap>
