<%@ Page Title="" Language="C#" MasterPageFile="~/Defult.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="ChateauDuPet.UI.WebForm1" %>
                ...
                <div class="row g-0  rounded overflow-hidden flex-md-row mb-4  h-md-250 position-relative">
                    ...
                    <div class="CentroContato container-xxl" style="width: 80%;">
                        ...
                        <div class="form-check">
                            ...
                            <button runat="server" class="btn btn-primary" id="BtnCadastrar" onclick="BtnCadastrar" />
